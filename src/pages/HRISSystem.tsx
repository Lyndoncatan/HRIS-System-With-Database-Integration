...
import { LayoutDashboard, Users, Clock, FileText, PhilippinePeso, Shield, Package, Settings, ArrowRight } from 'lucide-react';
...
const HRISSystem: FC = () => {
    ...
    const modules = [
        ...
        { icon: PhilippinePeso, label: 'Payroll', path: '/dashboard/payroll', gradient: 'linear-gradient(135deg, #dc2626, #ef4444)' },
